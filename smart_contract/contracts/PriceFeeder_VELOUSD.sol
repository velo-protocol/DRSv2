...
contract PriceFeeder is usingOraclize {
    ...
    function __callback(bytes32 id, string memory result) public {
        ...
        DigitalReserveSystem(digitalReserveSystemAddr).setPrice("USD", parseInt(result, 7));
    ...
    function updatePrice(uint delay) public payable {
        ...
        oraclize_query(delay, "URL", "json(https://dev-internal-system.lightnetapis.io/velo-fx-rates?convert=USD).data.\"1\".quote.USD.price");
    }
